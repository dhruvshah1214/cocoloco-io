/////////////////////////////////////////////////////////////////////////////////
//
//	The main menu script for creating the GUI for main menu/login of Cocoloco. Derived from demo main menu GUI.
//
...
public class CocolocoMainMenuGUI : Photon.MonoBehaviour
{
	...
	protected virtual void OnGUI()
	{
		...
		Vector2 scaleVector = new Vector2 ((Screen.width / 2), (Screen.height / 8));
		...
		DrawButton(m_StartButtonText, startPos, scaleVector,
		...
		DrawTextField("Name: ", m_Pos, scaleVector,
		...
		DrawButton(m_WeaponButtonText, m_Pos, scaleVector,
		...
		DrawButton(m_QualityButtonText, m_Pos, scaleVector,
			ButtonStyle, Color.white, Color.clear, BgTexture, delegate()
			{
		...
		DrawButton("Quit", m_Pos, scaleVector,
		ButtonStyle, Color.white, Color.clear, BgTexture, delegate()
		{
			Application.Quit();
		});
